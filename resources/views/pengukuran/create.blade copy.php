                ...
                <div>
                    ...
                    <select name="balita_id" id="balita_id" x-model="selectedBalita" @change="updateBalitaInfo()"
                        ...
                        <option value="{{ $balita->id }}"
                            ...
                            {{ old('balita_id', $balita->id ?? '') == $balita->id ? 'selected' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function onScanSuccess(decodedText) {
        ...
        if (nikInput) {
            ...
            // trigger update info balita otomatis
            if (window.pengukuranFormInstance) {
                window.pengukuranFormInstance.updateBalitaByNIK(decodedText);
            }
        }
    }
    ...
    // simpan instance Alpine
    document.addEventListener('alpine:init', () => {
        Alpine.data('pengukuranForm', pengukuranForm);
        window.pengukuranFormInstance = Alpine.store('pengukuranForm');
    });
</script>
@endpush